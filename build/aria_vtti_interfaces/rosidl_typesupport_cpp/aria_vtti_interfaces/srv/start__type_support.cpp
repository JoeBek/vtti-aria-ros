...
static const _Start_Request_type_support_symbol_names_t _Start_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aria_vtti_interfaces, srv, Start_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aria_vtti_interfaces, srv, Start_Request)),
  }
};
...
{
  return &::aria_vtti_interfaces::srv::rosidl_typesupport_cpp::Start_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aria_vtti_interfaces, srv, Start_Request)() {
  return get_message_type_support_handle<aria_vtti_interfaces::srv::Start_Request>();
}
...
static const _Start_Response_type_support_symbol_names_t _Start_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aria_vtti_interfaces, srv, Start_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aria_vtti_interfaces, srv, Start_Response)),
  }
};
...
{
  return &::aria_vtti_interfaces::srv::rosidl_typesupport_cpp::Start_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aria_vtti_interfaces, srv, Start_Response)() {
  return get_message_type_support_handle<aria_vtti_interfaces::srv::Start_Response>();
}
...
static const _Start_type_support_symbol_names_t _Start_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aria_vtti_interfaces, srv, Start)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aria_vtti_interfaces, srv, Start)),
  }
};
...
{
  return &::aria_vtti_interfaces::srv::rosidl_typesupport_cpp::Start_service_type_support_handle;
}
